                                ...
                                <AnimateOnScroll animation="fadeInDown" speed="normal">
                                    <div className="d-flex flex-column gspace-2">
                                        <div className="sub-heading">
                                            ...
                                            <span>ჩვენი ღირებულებები</span>
                                        </div>
                                        <h2 className="title-heading">პრინციპები, რომლებიც გვმართავს</h2>
                                        <p className="mb-0">ვებსაიტი ხარჯი არ არის — ეს არის ინვესტიცია შენი ბიზნესის ციფრულ განვითარებაში. სწორედ ამ პრინციპით ვმუშაობთ ყოველ პროექტზე.</p>
                                    </div>
                                </AnimateOnScroll>
