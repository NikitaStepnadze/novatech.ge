                            ...
                            <AnimateOnScroll animation="fadeInLeft" speed="fast">
                                <div
                                    ...
                                    <div className="sub-heading">
                                        ...
                                        <span>სიახლეები და რჩევები</span>
                                    </div>
                                    <h2 className="title-heading">სასარგებლო რჩევები ციფრული განვითარებისთვის</h2>
                                </div>
                            </AnimateOnScroll>
                        </div>
                        <div className="col col-lg-4 ps-0 pe-0">
                            <AnimateOnScroll animation="fadeInRight" speed="normal">
                                <div
                                    ...
                                    <p>
                                        წაიკითხე ჩვენი სტატიები ვებსაიტების, დიზაინისა და ციფრული
